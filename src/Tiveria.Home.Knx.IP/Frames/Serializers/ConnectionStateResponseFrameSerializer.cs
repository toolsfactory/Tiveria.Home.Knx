...
namespace Tiveria.Home.Knx.IP.Frames.Serializers
{
    ...
    public class ConnectionStateResponseFrameSerializer : FrameSerializerBase<ConnectionStateResponseFrame>
    {
        ...
        public override ConnectionStateResponseFrame Deserialize(BigEndianBinaryReader reader)
        {
            ...
            return new ConnectionStateResponseFrame(header, channelId, status);
        }

        public override void Serialize(ConnectionStateResponseFrame frame, BigEndianBinaryWriter writer)
        {
