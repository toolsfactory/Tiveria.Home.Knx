...
namespace Tiveria.Home.Knx.IP.Frames.Serializers
{
    ...
    public class DeviceConfigurationAcknowledgeFrameSerializer : FrameSerializerBase<DeviceConfigurationAcknowledgeFrame>
    {
        ...
        public override DeviceConfigurationAcknowledgeFrame Deserialize(BigEndianBinaryReader reader)
        {
            ...
            return new DeviceConfigurationAcknowledgeFrame(header, channelId, seqCounter, status);
        }

        public override void Serialize(DeviceConfigurationAcknowledgeFrame frame, BigEndianBinaryWriter writer)
        {
