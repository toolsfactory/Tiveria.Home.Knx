...
namespace Tiveria.Home.Knx.IP.Frames.Serializers
{
    ...
    /// </code>
    /// </summary>
    public class ConnectionRequestFrameSerializer : FrameSerializerBase<ConnectionRequestFrame>
    {
        public override ServiceTypeIdentifier ServiceTypeIdentifier => ServiceTypeIdentifier.ConnectRequest;

        public override ConnectionRequestFrame Deserialize(BigEndianBinaryReader reader)
        {
            ...
            return new ConnectionRequestFrame(header, dataEndpoint, controlEndpoint, cri);
        }

        public override void Serialize(ConnectionRequestFrame frame, BigEndianBinaryWriter writer)
        {
            frame.FrameHeader.Write(writer);
            frame.DataEndpoint.Write(writer);
            frame.ControlEndpoint.Write(writer);
            frame.Cri.Write(writer);
        }
    }
}