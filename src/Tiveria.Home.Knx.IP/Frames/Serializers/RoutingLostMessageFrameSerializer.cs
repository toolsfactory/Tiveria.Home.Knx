...
namespace Tiveria.Home.Knx.IP.Frames.Serializers
{
    public class RoutingLostMessageFrameSerializer : FrameSerializerBase<RoutingLostMessageFrame>
    {
        ...
        public override RoutingLostMessageFrame Deserialize(BigEndianBinaryReader reader)
        {
            ...
            return new RoutingLostMessageFrame(header, lostMessageInfo);
        }

        public override void Serialize(RoutingLostMessageFrame frame, BigEndianBinaryWriter writer)
        {
            frame.FrameHeader.Write(writer);
            frame.LostMessageInfo.Write(writer);
        }
    }
}