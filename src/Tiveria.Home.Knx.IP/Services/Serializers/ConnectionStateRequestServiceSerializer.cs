...
namespace Tiveria.Home.Knx.IP.Services.Serializers
{
    ...
    public class ConnectionStateRequestServiceSerializer : ServiceSerializerBase<ConnectionStateRequestService>
    {
        ...
        public override ConnectionStateRequestService Deserialize(BigEndianBinaryReader reader)
        {
            ...
            return new ConnectionStateRequestService(channelId, controlEndpoint);
        }

        public override void Serialize(ConnectionStateRequestService service, BigEndianBinaryWriter writer)
        {
