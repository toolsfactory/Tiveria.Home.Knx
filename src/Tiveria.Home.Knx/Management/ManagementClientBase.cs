...
{
    /// <summary>
    /// Base implementation used in all transport specific <see cref="IConnectedDeviceManagement"/> implementations
    /// </summary>
    public abstract class ManagementClientBase
    {
        ...
        /// Base constructor
        /// </summary>
        /// <param name="connection">The knx bus client to be used</param>
