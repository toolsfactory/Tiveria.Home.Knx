...
namespace Tiveria.Home.Knx.IP
{
    ...
    {
        private readonly KnxNetIPFrame _frame;
        private readonly DateTime _timestamp;
        private readonly bool _handled;

        public KnxNetIPFrame Frame => _frame; 
        public DateTime TimeStamp => _timestamp;
        public bool Handled => _handled;
        public FrameReceivedEventArgs(DateTime timestamp, KnxNetIPFrame frame, bool handled)
        {
