...
{
    public class Apci : IKnxDataElement
    {
        ...
        public bool OptimizationAllowed { get; init; }
        ...
        {
            writer.Write(_TypeDetails.HighBits);
            if (_TypeDetails.CanOptimize && OptimizationAllowed && Data.Length == 1 && Data[0] <= 63)
                writer.Write((byte)(_TypeDetails.LowBits | Data[0]));
            else
            {
                writer.Write(_TypeDetails.LowBits);
                writer.Write(Data);
            }
        }
        ...
        public static Apci Parse(Span<byte> buffer)
        {
            ...
            return new Apci(details.Type, data, buffer.Length == 2);
