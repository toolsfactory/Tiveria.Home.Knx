...
namespace Tiveria.Home.Knx.Cemi
{
    ...
    public class CemiLData : CemiBase, ICemi
    {
        ...
        protected IAddress _destinationAddress;
        ...
        public IAddress DestinationAddress => _destinationAddress;
        ...
        public static CemiLData CreateReadRequestCemi(IndividualAddress srcAddress, IAddress dstAddress, Priority priority = Priority.Normal)
        {
            return new CemiLData(CemiMessageCode.LDATA_REQ, srcAddress, dstAddress, new byte[2] { 0, 0 }, priority);
        }

        public static CemiLData CreateReadAnswerCemi(IndividualAddress srcAddress, IAddress dstAddress, byte[] data, Priority priority = Priority.Normal)
        {
