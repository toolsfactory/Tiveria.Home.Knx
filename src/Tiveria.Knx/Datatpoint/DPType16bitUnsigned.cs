...
{
    public class DPType16bitUnsigned : DPType<ushort>
    {
        protected DPType16bitUnsigned(string id, string name, ushort min = 0, ushort max = ushort.MaxValue, string unit = "", string description = "") : base(id, name, min, max, unit, description)
        { }
        ...
        public static DPType16bitUnsigned DPT_TIMEPERIOD_10MS  = new DPType16bitUnsigned("7.003", "Time Period 10ms resolution", 0, 65535, "ms");
        public static DPType16bitUnsigned DPT_TIMEPERIOD_100MS = new DPType16bitUnsigned("7.004", "Time Period 100ms resolution", 0, 65535, "ms");
